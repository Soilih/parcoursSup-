...
class UniversiteController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('universite_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('universite/new.html.twig', [
    ...
    public function edit(Request $request, Universite $universite): Response
    {
        ...
        return $this->renderForm('universite/edit.html.twig', [
            'universite' => $universite,
            'form' => $form,
        ]);
    }
